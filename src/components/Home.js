        ...
        <div className="HOME">
            ...
            <div className="below-home">
                ...
                <div className="contacts">
                    ...
                    <button className="work cursor" onClick={() => window.location.href = "mailto:andilezondo555@gmail.com"} style={{color: 'white'}}>
                         Message me
                    </button>
                </div>
            ...
            <div className="profilePic" onClick={() => window.location.href = "mailto:andilezondo555@gmail.com"}>
